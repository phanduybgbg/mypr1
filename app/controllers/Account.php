...
class Account extends Controller
{
    ...
    public function login()
    {
        ...
        // die(password_hash($dataPost['password'], PASSWORD_BCRYPT));
    ...
    function registerApi()
    {
        ...
        $body = 'Click vào đây để hoàn thành đăng ký của bạn: <a href="http://localhost:8000/signup-comfirm/' . $token . '">Xác nhận</a> Đường dẫn sẽ hết hạn trong 15 phút.';
    ...
    function forgotPasswordApi()
    {
        ...
        $body = 'Click vào đây để xác nhận email của bạn: <a href="http://localhost:8000/account/finalForgotPassword/' . $token . '">Xác nhận</a> Đường dẫn sẽ hết hạn trong 15 phút.';
